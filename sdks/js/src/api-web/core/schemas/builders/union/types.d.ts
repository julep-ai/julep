...
export declare type inferRawUnion<
...
export declare type inferParsedUnion<
  D extends string | Discriminant<any, any>,
  U extends UnionSubtypes<keyof U>,
> = {
...
export declare type inferRawDiscriminant<
  D extends string | Discriminant<any, any>,
> = D extends string ? D : D extends Discriminant<infer Raw, any> ? Raw : never;
export declare type inferParsedDiscriminant<
  D extends string | Discriminant<any, any>,
> = D extends string
  ? D
