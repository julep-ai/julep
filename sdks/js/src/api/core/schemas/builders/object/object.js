  ...
  const baseSchema = {
    ...
    parse: (raw, opts) =>
      __awaiter(this, void 0, void 0, function* () {
        ...
        const requiredKeys = [];
        for (const [parsedKey, schemaOrObjectProperty] of (0,
        entries_1.entries)(schemas)) {
...
function validateAndTransformExtendedObject({
  ...
  return __awaiter(this, void 0, void 0, function* () {
    ...
    const transformedBase = yield transformBase(
      (0, filterObject_1.filterObject)(value, baseProperties),
    );
    const transformedExtension = yield transformExtension(
