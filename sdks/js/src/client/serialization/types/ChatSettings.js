...
exports.ChatSettings = core.serialization.object({
    ...
    responseFormat: core.serialization.property("response_format", core.serialization.lazyObject(() => __awaiter(void 0, void 0, void 0, function* () { return (yield Promise.resolve().then(() => __importStar(require("..")))).ChatSettingsResponseFormat; })).optional()),
    seed: core.serialization.number().optional(),
    stop: core.serialization.lazy(() => __awaiter(void 0, void 0, void 0, function* () { return (yield Promise.resolve().then(() => __importStar(require("..")))).ChatSettingsStop; })).optional(),
