...
if TYPE_CHECKING:
    from ..models.prompt_step_prompt_type_1_item_content_type_2_item_type_0 import (
        PromptStepPromptType1ItemContentType2ItemType0,
    )
    from ..models.prompt_step_prompt_type_1_item_content_type_2_item_type_1 import (
        PromptStepPromptType1ItemContentType2ItemType1,
    )


T = TypeVar("T", bound="PromptStepPromptType1Item")


@_attrs_define
class PromptStepPromptType1Item:
    """
    Attributes:
        role (EntriesChatMLRole): ChatML role (system|assistant|user|function_call|function|function_response|auto)
        content (Union[List[Union['PromptStepPromptType1ItemContentType2ItemType0',
            'PromptStepPromptType1ItemContentType2ItemType1']], List[str], str]): The content parts of the message
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
                    ...
                    def _parse_content_type_2_item(
                        ...
                        try:
                            if not isinstance(data, dict):
                                raise TypeError()
                            content_type_2_item_type_0 = PromptStepPromptType1ItemContentType2ItemType0.from_dict(
                                data
                            )
                        ...
                        content_type_2_item_type_1 = (
                            PromptStepPromptType1ItemContentType2ItemType1.from_dict(
                                data
                            )
                        )
        ...
        prompt_step_prompt_type_1_item = cls(
            role=role,
            content=content,
            name=name,
            continue_=continue_,
        ...
        prompt_step_prompt_type_1_item.additional_properties = d
        return prompt_step_prompt_type_1_item
