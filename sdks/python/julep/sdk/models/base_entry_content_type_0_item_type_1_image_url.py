...
T = TypeVar("T", bound="BaseEntryContentType0ItemType1ImageUrl")


@_attrs_define
class BaseEntryContentType0ItemType1ImageUrl:
    """The image URL
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        base_entry_content_type_0_item_type_1_image_url = cls(
            url=url,
            detail=detail,
        )

        base_entry_content_type_0_item_type_1_image_url.additional_properties = d
        return base_entry_content_type_0_item_type_1_image_url
