...
T = TypeVar("T", bound="PatchTaskRequestMainItemType17")


@_attrs_define
class PatchTaskRequestMainItemType17:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        patch_task_request_main_item_type_17 = cls(
            over=over,
            map_=map_,
            reduce=reduce,
            initial=initial,
        ...
        patch_task_request_main_item_type_17.additional_properties = d
        return patch_task_request_main_item_type_17
