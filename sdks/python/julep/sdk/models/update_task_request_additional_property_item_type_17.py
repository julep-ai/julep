...
from ..models.update_task_request_additional_property_item_type_17_kind import (
...
T = TypeVar("T", bound="UpdateTaskRequestAdditionalPropertyItemType17")


@_attrs_define
class UpdateTaskRequestAdditionalPropertyItemType17:
    """
    Attributes:
        kind (UpdateTaskRequestAdditionalPropertyItemType17Kind): The kind of step Default:
            UpdateTaskRequestAdditionalPropertyItemType17Kind.MAP_REDUCE.
    ...
    kind: UpdateTaskRequestAdditionalPropertyItemType17Kind = (
        UpdateTaskRequestAdditionalPropertyItemType17Kind.MAP_REDUCE
    )
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        kind = UpdateTaskRequestAdditionalPropertyItemType17Kind(d.pop("kind_"))
        ...
        update_task_request_additional_property_item_type_17 = cls(
            kind=kind,
            over=over,
            map_=map_,
            reduce=reduce,
        ...
        update_task_request_additional_property_item_type_17.additional_properties = d
        return update_task_request_additional_property_item_type_17
