...
T = TypeVar("T", bound="PatchTaskRequestAdditionalPropertyItemType17")


@_attrs_define
class PatchTaskRequestAdditionalPropertyItemType17:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        kind = d.pop("kind_", UNSET)

        patch_task_request_additional_property_item_type_17 = cls(
            over=over,
            map_=map_,
            reduce=reduce,
            initial=initial,
        ...
        patch_task_request_additional_property_item_type_17.additional_properties = d
        return patch_task_request_additional_property_item_type_17
