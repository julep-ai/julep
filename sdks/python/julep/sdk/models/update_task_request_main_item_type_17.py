...
from ..models.update_task_request_main_item_type_17_kind import (
...
T = TypeVar("T", bound="UpdateTaskRequestMainItemType17")


@_attrs_define
class UpdateTaskRequestMainItemType17:
    """
    Attributes:
        kind (UpdateTaskRequestMainItemType17Kind): The kind of step Default:
            UpdateTaskRequestMainItemType17Kind.MAP_REDUCE.
    ...
    kind: UpdateTaskRequestMainItemType17Kind = (
        UpdateTaskRequestMainItemType17Kind.MAP_REDUCE
    )
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        kind = UpdateTaskRequestMainItemType17Kind(d.pop("kind_"))
        ...
        update_task_request_main_item_type_17 = cls(
            kind=kind,
            over=over,
            map_=map_,
            reduce=reduce,
        ...
        update_task_request_main_item_type_17.additional_properties = d
        return update_task_request_main_item_type_17
