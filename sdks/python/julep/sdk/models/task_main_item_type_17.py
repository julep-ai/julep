...
from ..models.task_main_item_type_17_kind import TaskMainItemType17Kind
...
T = TypeVar("T", bound="TaskMainItemType17")


@_attrs_define
class TaskMainItemType17:
    """
    Attributes:
        kind (TaskMainItemType17Kind): The kind of step Default: TaskMainItemType17Kind.MAP_REDUCE.
    ...
    kind: TaskMainItemType17Kind = TaskMainItemType17Kind.MAP_REDUCE
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        kind = TaskMainItemType17Kind(d.pop("kind_"))
        ...
        task_main_item_type_17.additional_properties = d
        return task_main_item_type_17
