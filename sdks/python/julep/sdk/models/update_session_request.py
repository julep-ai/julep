...
class UpdateSessionRequest:
    r"""Payload for updating a session
    ...
    Attributes:
        ...
        metadata (Union[Unset, UpdateSessionRequestMetadata]):
    """
    ...
    metadata: Union[Unset, "UpdateSessionRequestMetadata"] = UNSET
    additional_properties: Dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> Dict[str, Any]:
        from ..models.update_session_request_metadata import (
