...
if TYPE_CHECKING:
    from ..models.create_task_request_additional_property_item_type_17 import (
        CreateTaskRequestAdditionalPropertyItemType17,
    )
    from ..models.create_task_request_input_schema_type_0 import (
        CreateTaskRequestInputSchemaType0,
    )
    from ..models.create_task_request_main_item_type_17 import (
...
class CreateTaskRequest:
    ...
    Attributes:
        ...
        main (List[Union['CreateTaskRequestMainItemType17', 'EmbedStep', 'ErrorWorkflowStep', 'EvaluateStep',
            'ForeachStep', 'GetStep', 'IfElseWorkflowStep', 'LogStep', 'ParallelStep', 'PromptStep', 'ReturnStep',
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if isinstance(self.input_schema, CreateTaskRequestInputSchemaType0):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for main_item_data in _main:
            ...
            def _parse_main_item(
                ...
                if not isinstance(data, dict):
                    raise TypeError()
                main_item_type_17 = CreateTaskRequestMainItemType17.from_dict(data)
        ...
        def _parse_input_schema(
            data: object,
        ) -> Union["CreateTaskRequestInputSchemaType0", None]:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                input_schema_type_0 = CreateTaskRequestInputSchemaType0.from_dict(data)

                return input_schema_type_0
            except:  # noqa: E722
                pass
            return cast(Union["CreateTaskRequestInputSchemaType0", None], data)
        ...
        if isinstance(_metadata, Unset):
            ...
            metadata = CreateTaskRequestMetadata.from_dict(_metadata)
            ...
            for additional_property_item_data in _additional_property:
                ...
                def _parse_additional_property_item(
                    ...
                    additional_property_item_type_17 = (
                        CreateTaskRequestAdditionalPropertyItemType17.from_dict(data)
                    )
        ...
        create_task_request.additional_properties = additional_properties
