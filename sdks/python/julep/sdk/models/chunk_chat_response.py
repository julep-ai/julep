...
if TYPE_CHECKING:
    from ..models.chat_output_chunk import ChatOutputChunk
...
@_attrs_define
class ChunkChatResponse:
    """
    Attributes:
        choices (List['ChatOutputChunk']): The deltas generated by the model
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for choices_item_data in _choices:
            choices_item = ChatOutputChunk.from_dict(choices_item_data)
        ...
        chunk_chat_response.additional_properties = d
        return chunk_chat_response
