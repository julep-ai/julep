...
from ..models.create_task_request_main_item_type_17_kind import (
...
T = TypeVar("T", bound="CreateTaskRequestMainItemType17")


@_attrs_define
class CreateTaskRequestMainItemType17:
    """
    Attributes:
        kind (CreateTaskRequestMainItemType17Kind): The kind of step Default:
            CreateTaskRequestMainItemType17Kind.MAP_REDUCE.
    ...
    kind: CreateTaskRequestMainItemType17Kind = (
        CreateTaskRequestMainItemType17Kind.MAP_REDUCE
    )
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        kind = CreateTaskRequestMainItemType17Kind(d.pop("kind_"))
        ...
        create_task_request_main_item_type_17 = cls(
            kind=kind,
            over=over,
            map_=map_,
            reduce=reduce,
        ...
        create_task_request_main_item_type_17.additional_properties = d
        return create_task_request_main_item_type_17
