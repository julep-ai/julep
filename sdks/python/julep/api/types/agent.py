...
class Agent(pydantic_v1.BaseModel):
    id: CommonUuid
    ...
    instructions: AgentInstructions = pydantic_v1.Field()
    """
    Instructions for the agent
    """

    default_settings: typing.Optional[AgentDefaultSettings] = pydantic_v1.Field(
        default=None
    )
    """
