...
class Base(pydantic.BaseModel):
    function: typing.Optional[ToolsFunctionCallOption]
...
class ToolsChosenToolCall_Function(ToolsChosenFunctionCall, Base):
...
ToolsChosenToolCall = typing.Union[ToolsChosenToolCall_Function]
