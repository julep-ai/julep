import { Common_limit, Common_offset, Common_uuid, Sessions_CreateSessionRequest, Sessions_PatchSessionRequest, Sessions_UpdateSessionRequest } from "./api";
...
export class SessionsRoutes extends BaseRoutes {
    ...
    async createOrUpdate({
        ...
        return await this.apiClient.default.sessionsRouteCreateOrUpdate({ id, requestBody })
    }
    ...
    async list({
        ...
        return await this.apiClient.default.sessionsRouteList({ limit, offset, sortBy, direction, metadataFilter })
    }
    ...
    async update({
        ...
        return await this.apiClient.default.sessionsRouteUpdate({ id, requestBody })
    }
}