...
export class TasksRoutes extends BaseRoutes {
    ...
    async createOrUpdate({
        ...
        return await this.apiClient.default.tasksCreateOrUpdateRouteCreateOrUpdate({ parentId, id, requestBody })
    }
    ...
    async list({
        ...
        return await this.apiClient.default.tasksRouteList({ id, limit, offset, sortBy, direction, metadataFilter })
    }
    ...
    async patch({
        ...
        return await this.apiClient.default.tasksRoutePatch({ id, childId, requestBody })
    }
    ...
    async update({
        ...
        return await this.apiClient.default.tasksRouteUpdate({ id, childId, requestBody })
    }
    ...
    async createExecution({
        ...
        return await this.apiClient.default.taskExecutionsRouteCreate({ id, requestBody })
    }
