...
export class AgentsRoutes extends BaseRoutes{
    ...
    async createDoc({ id, requestBody }: {
        id: Common_uuid;
        requestBody: Docs_CreateDocRequest;
    }) {
        return await this.apiClient.default.agentDocsRouteCreate({ id, requestBody })
    }
    ...
    async listDocs({
        ...
        return await this.apiClient.default.agentDocsRouteList({ id, limit, offset, sortBy, direction, metadataFilter })
    }

    async createTool({ id, requestBody }: {
        id: Common_uuid;
        requestBody: Agents_CreateAgentRequest;
    }) {
        return await this.apiClient.default.agentToolsRouteCreate({ id, requestBody })
    }

    async deleteTool({ id, childId }: {
        id: Common_uuid;
        childId: Common_uuid;
    }) {
    ...
    async listTools(
        ...
        return await this.apiClient.default.agentToolsRouteList({ id, limit, offset, sortBy, direction, metadataFilter })
    }
    ...
    async patchTool({
        ...
        return await this.apiClient.default.agentToolsRoutePatch({ id, childId, requestBody })
    }
    ...
    async updateTool(
        ...
        return await this.apiClient.default.agentToolsRouteUpdate({ id, childId, requestBody })
    }
}