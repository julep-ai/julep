...
- [Julep](julep/index.md#julep)
    - [Api](julep/api/index.md#api)
        ...
        - [Types](julep/api/types/index.md#types)
            ...
            - [ChatMlImageContentPart](julep/api/types/chat_ml_image_content_part.md#chatmlimagecontentpart)
            - [ChatMlImageContentPartImageUrl](julep/api/types/chat_ml_image_content_part_image_url.md#chatmlimagecontentpartimageurl)
            - [ChatMlImageContentPartImageUrlDetail](julep/api/types/chat_ml_image_content_part_image_url_detail.md#chatmlimagecontentpartimageurldetail)
            - [ChatMlMessage](julep/api/types/chat_ml_message.md#chatmlmessage)
            - [Chat Ml Message Content](julep/api/types/chat_ml_message_content.md#chat-ml-message-content)
            - [Chat Ml Message Content Item](julep/api/types/chat_ml_message_content_item.md#chat-ml-message-content-item)
            - [ChatMlMessageRole](julep/api/types/chat_ml_message_role.md#chatmlmessagerole)
            - [ChatMlTextContentPart](julep/api/types/chat_ml_text_content_part.md#chatmltextcontentpart)
            ...
            - [Input Chat Ml Message Content](julep/api/types/input_chat_ml_message_content.md#input-chat-ml-message-content)
            - [Input Chat Ml Message Content Item](julep/api/types/input_chat_ml_message_content_item.md#input-chat-ml-message-content-item)
