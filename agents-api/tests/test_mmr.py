...
def test_utility_test_to_apply_mmr_to_docs():
    """utility: test to apply_mmr_to_docs"""
...
def test_utility_test_mmr_with_different_mmr_strength_values():
    """utility: test mmr with different mmr_strength values"""
    # Create test documents with embeddings
    docs = [
        create_test_doc(
...
def test_utility_test_mmr_with_empty_docs_list():
    """utility: test mmr with empty docs list"""
    query_embedding = np.array([0.3, 0.3, 0.3])
