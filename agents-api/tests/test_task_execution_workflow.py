...
async def test_task_execution_workflow_handle_integration_tool_call_step_integration_tools_not_found():
    ...
    with (
        ...
        assert str(exc.value) == "Integration tool1 not found"
...
async def test_task_execution_workflow_handle_api_call_tool_call_step_do_not_include_response_content():
...
async def test_task_execution_workflow_handle_prompt_step_unwrap_is_false_finish_reason_is_not_tool_calls():
    wf = TaskExecutionWorkflow()
