...
from agents_api.env import api_key_header_name, api_key, multi_tenant_mode
...
def _(client: TestClient=client, test_execution_started=test_execution_started, test_developer_id=test_developer_id):
    ...
    with patch("agents_api.routers.tasks.stream_execution_status.execution_status_publisher", mock_sse_publisher):
