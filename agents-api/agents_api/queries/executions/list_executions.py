...
SELECT
    ...
    step_label,
    task_token,
    total_transitions AS transition_count,
    transition_metadata
FROM
    latest_executions
WHERE
    ...
    task_id = $2
ORDER BY
    -- Sort by created_at if that's the selected field
    CASE WHEN $3 = 'asc' AND $4 = 'created_at' THEN created_at END ASC NULLS LAST,
    CASE WHEN $3 = 'desc' AND $4 = 'created_at' THEN created_at END DESC NULLS LAST,
    -- Sort by updated_at if that's the selected field (more recent transitions)
    CASE WHEN $3 = 'asc' AND $4 = 'updated_at' THEN updated_at END ASC NULLS LAST,
    CASE WHEN $3 = 'desc' AND $4 = 'updated_at' THEN updated_at END DESC NULLS LAST
LIMIT $5 OFFSET $6;
"""
    ...
    *,
    ...
    return (
        ...
        [
            ...
            task_id,
            direction,
            sort_by,  # Now passing sort_by as parameter
            limit,
            offset,
        ],
    )
