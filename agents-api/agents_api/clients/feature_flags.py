...
from agents_api.env import unleash_url, unleash_api_token, unleash_app_name
...
class UnleashProvider(AbstractProvider):
    ...
    def _initialize_unleash(self):
        ...
        try:
            ...
            logger.warning("⚠️ UnleashClient not available, feature flags will use default values")
            self._unleash_client = None
    ...
    def _build_unleash_context(self, evaluation_context: Optional[EvaluationContext]) -> dict:
    ...
    def resolve_boolean_details(
        ...
        try:
            ...
            return FlagResolutionDetails(
                value=result,
                reason=Reason.TARGETING_MATCH if result else Reason.DEFAULT
            )
    ...
    def resolve_string_details(
        ...
        try:
            ...
            logger.debug(f"String feature flag '{flag_key}' returning default value: {default_value}")
    ...
    def resolve_integer_details(
        ...
        try:
            ...
            # In a real implementation, you might use variants or custom logic
            logger.debug(f"Integer feature flag '{flag_key}' returning default value: {default_value}")
    ...
    def resolve_float_details(
        ...
        try:
            ...
            # In a real implementation, you might use variants or custom logic
            logger.debug(f"Float feature flag '{flag_key}' returning default value: {default_value}")
    ...
    def resolve_object_details(
        ...
        try:
            ...
            # In a real implementation, you might use variants or custom logic
            logger.debug(f"Object feature flag '{flag_key}' returning default value: {default_value}")
        ...
        try:
            ...
            if context:
                evaluation_context = EvaluationContext(
                    targeting_key=context.get("developer_id"),
                    attributes=context
                )
