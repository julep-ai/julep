...
from ...common.utils.tool_runner import format_tool
...
async def prompt_step(context: StepContext) -> StepOutcome:
    ...
    if get_feature_flag_value("auto_tool_calls_prompt_step", developer_id=context.execution_input.developer_id):
