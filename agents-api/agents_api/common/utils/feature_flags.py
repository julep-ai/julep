...
from agents_api.clients.feature_flags import get_feature_flag_client, FeatureFlagContext
...
def is_auto_tool_calls_enabled(developer_id: Optional[str] = None) -> bool:
    """
