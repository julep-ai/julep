...
from agents_api.models.execution.update_execution_transition import update_execution_transition_query
...
async def list_execution_transitions(
    ...
    res = list_execution_transitions_query(execution_id=execution_id, limit=limit, offset=offset)
