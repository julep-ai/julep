...
async def create_responses_user(
    developer_id: UUID, create_response_data: CreateResponse
) -> UUID:
...
async def create_responses_session(
    developer_id: UUID, create_response_data: CreateResponse, agent_id: UUID
) -> UUID:
