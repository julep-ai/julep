...
<Tip>
    Check out the API reference [here](/api-reference/executions) or SDK reference (Python [here](/sdks/python/executions) or JavaScript [here](/sdks/nodejs/executions) for more details on different operations you can perform on executions.
</Tip>
...
- [Checkout the Tutorial](/docs/tutorials) - Learn how to use executions in a tutorial
- [Checkout the Execution Lifecycle](/docs/advanced/execution-lifecycle) - Learn more about the execution lifecycle
