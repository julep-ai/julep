...
| `default_system_template` | string              | Default system template for all sessions created by this agent. See [default system template details](/docs/concepts/agents#default-system-template) for more information. | See [default system template](/docs/concepts/agents#default-system-template) |
