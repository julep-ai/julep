...
<Tip>
    Check out the API reference [here](/api-reference/tasks) or SDK reference (Python [here](/sdks/python/tasks) or JavaScript [here](/sdks/nodejs/tasks) for more details on different operations you can perform on tasks.
</Tip>
...
<Tip>
    Check out the API reference [here](/api-reference/executions) or SDK reference (Python [here](/sdks/python/executions) or JavaScript [here](/sdks/nodejs/executions) for more details on different operations you can perform on tasks.
</Tip>
