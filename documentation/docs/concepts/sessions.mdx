...
<Tip>
    Check out the API reference [here](/api-reference/sessions) or SDK reference (Python [here](/sdks/python/reference#sessions) or JavaScript [here](/sdks/nodejs/reference#sessions) for more details on different operations you can perform on sessions.
</Tip>
...
<Tip>
    Check out the API reference [here](/api-reference/sessions/chat) or SDK reference (Python [here](/sdks/python/reference#sessions) or JavaScript [here](/sdks/nodejs/reference#sessions) for more details on different operations you can perform on sessions.
</Tip>
