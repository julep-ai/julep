...
| `recall_options`     | `VectorDocSearch \| TextOnlyDocSearch \| HybridDocSearch \| None`                    | Options for recalling context or certain data during the session                                  | `None`         |
...
<Tabs>
  <Tab title="Vector Search">
    ...
    | `confidence`      | `float`   | The confidence cutoff level (-1 to 1)                                                      | `0`     |
    | `mmr_strength`    | `float`   | MMR Strength (mmr_strength = 1 - mmr_lambda) (0 to 1)                                     | `0`     |
  </Tab>
  ...
  <Tab title="Hybrid Search">
    ...
    | `limit`           | `int`     | The limit of documents to return (1-50)                                                    | `10`    |
    | `metadata_filter` | `object`  | Metadata filter to apply to the search                                                     | `{}`    |
    | `alpha`           | `float`   | Weight between BM25 and Vector search (0=pure BM25, 1=pure vector)                        | `0.75`  |
    | `confidence`      | `float`   | The confidence cutoff level (-1 to 1)                                                      | `0`     |
    | `mmr_strength`    | `float`   | MMR Strength (mmr_strength = 1 - mmr_lambda) (0 to 1)                                     | `0`     |
    | `lang`            | `str`     | The language for text search (other languages coming soon)                                 | `en-US` |
  </Tab>
