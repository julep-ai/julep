...
|------------------|-----------------|---------|-----------------------------------------------------------------------------------------------|
| `vector`         | `List[float]`   |  **Required**      | The embedding vector representing the semantic meaning of the query.               |
| `alpha`          | `float`         | `0.7`   | The weight assigned to embedding-based results versus text-based results.                     |
| `confidence`     | `float`         | `0.5`   | The confidence threshold for embedding similarity.                                            |
| `metadata_filter`| `object`        |  None   | Filters to apply based on document metadata.                                                  |
| `k`              | `int`           | `3`     | The number of top results to return.                                                          |
...
| `alpha`           | `float`        | The weight assigned to embedding-based results versus text-based results.       | `0.7`       |
| `confidence`      | `float`        | The confidence threshold for embedding similarity.                              | `0.5`       |
| `metadata_filter` | `object`       | Filters to apply based on document metadata.                                    | `None`      |
| `k`               | `int`          | The number of top results to return.                                            | `3`         |
| `lang`            | `str`          | The language to use for full-text search processing.                            | `'en-US'`   |
