---
title: 'Spider Crawler Integration'
...
<Info type="info" title="API Key Required">
  To use the Spider integration, you need an API key. You can obtain this key by signing up at [Spider](https://spider.com/signup).
</Info>
...
<Steps>
  <Step title="Configure Your API Key">
    Add your API key to the Julep dashboard under the integrations section. This will allow Julep to authenticate requests to Spider on your behalf.
  </Step>
...
<AccordionGroup>
  ...
  <Accordion title="Tool Configuration">
    ...
    - **_integration_**: Details the provider and setup for the integration.
      ...
      - **_method_**: Specifies the method to use, such as `crawl`, `links`, `screenshot`, or `search`.
...
For further assistance, feel free to reach out to our support team or consult the [Spider API documentation](https://spider.cloud/docs/api).
