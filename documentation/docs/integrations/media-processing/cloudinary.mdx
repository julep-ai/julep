...
<Steps>
  <Step title="Configure Your API Key">
    Add your API key, API secret, and cloud name to the Julep dashboard under the integrations section. This will allow Julep to authenticate requests to Cloudinary on your behalf.
  </Step>
...
<AccordionGroup>
  ...
  <Accordion title="Tool Configuration">
    ...
    - **_integration_**: Details the provider and setup for the integration.
      ...
      - **_method_**: Specifies the method to use, either `media_upload` or `media_edit`.
      - **_setup_**: Contains configuration details, such as the API key, API secret, and cloud name.
...
For further assistance, feel free to reach out to our support team or consult the [Cloudinary API documentation](https://cloudinary.com/documentation/python_quickstart).
