  ...
  <Accordion title="Workflow Configuration">
    - **_main_**: Defines the main execution steps.
      ...
      - **_arguments_**: Specifies the input parameters for the tool:
        ...
        - **_load_max_docs_**: (optional) Maximum number of documents to load. Defaults to 2.
  </Accordion>
</AccordionGroup>
...
For further assistance, feel free to reach out to our support team or consult the [Wikipedia API documentation](https://wikipedia.readthedocs.io/en/latest/).
