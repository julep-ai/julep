...
<Steps>
  <Step title="Configure Your API Key">
    Add your API key to the Julep dashboard under the integrations section. This will allow Julep to authenticate requests to Brave Search on your behalf.
  </Step>
...
For further assistance, feel free to reach out to our support team or consult the [Brave Search API documentation](https://api.search.brave.com/app/documentation/web-search/get-started).
