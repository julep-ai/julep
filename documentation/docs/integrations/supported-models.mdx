...
| l3.1-euryale-70b | 8K tokens | Creative tasks |
...
| Alibaba-NLP/gte-large-en-v1.5 | 8K tokens | Cost-effective solutions |
| BAAI/bge-m3 | 8K tokens | Cost-effective solutions |
| vertex_ai/text-embedding-004 | 8K tokens | Google Cloud integration |
