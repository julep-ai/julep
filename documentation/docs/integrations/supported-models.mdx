...
| o3-mini | 200K tokens | Quick tasks |
...
| Model Name | Context Window | Best For |
|------------|---------------|-----------|
| groq-llama-3.1-70b | 8K tokens | Long-form content |
| groq-llama-3.1-8b | 8K tokens | Quick processing |
...
| Model Name | Context Window | Best For |
|------------|---------------|-----------|
| openrouter-mistral-large-2411 | 128K tokens | High performance |
| openrouter-qwen-2.5-72b-instruct | 131K tokens | Complex instructions |
| openrouter-eva-llama-3.33-70b | 128K tokens | Creative tasks |
| openrouter-l3.1-euryale-70b | 128K tokens | Creative tasks |
| openrouter-l3.3-euryale-70b | 128K tokens | Creative tasks |
| openrouter-magnum-v4-72b | 8K tokens | Creative tasks |
| openrouter-eva-qwen-2.5-72b | 8K tokens | Creative tasks |
| openrouter-hermes-3-llama-3.1-70b | 8K tokens | Creative tasks |
| openrouter-deepseek-chat | 32K tokens | Conversational AI |
...
| Model Name | Context Window | Best For |
|------------|---------------|-----------|
| cerebras-llama-3.1-70b | 8K tokens | Creative tasks |
| cerebras-llama-3.1-8b | 8K tokens | Creative tasks |
...
<Info>
Not all parameters are supported by every model. Please refer to the [LiteLLM documentation](https://docs.litellm.ai/docs/completion/input) for more details.
</Info>
