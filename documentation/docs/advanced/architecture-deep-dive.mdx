...
<AccordionGroup>
  <Accordion title="Authentication" icon="lock" defaultOpen={true}>
    <ol>
      <li>API key-based access</li>
  ...
  <Accordion title="Data Protection" icon="shield" defaultOpen={true}>
    <ol>
  ...
  <Accordion title="Monitoring" icon="chart-line" defaultOpen={true}>
    <ol>
      <li>Audit logging</li>
