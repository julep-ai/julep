...
Python expressions can be used in various task steps. For a complete list of step types and their syntax, refer to the [Step Types](/docs/advanced/types-of-task-steps) page.
