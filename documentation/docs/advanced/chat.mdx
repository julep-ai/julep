...
<Info>  
  - To use the Document(RAG) with the chat API, you need to create a session with the `recall_options` parameter set to appropriate search parameters. To learn more about the `recall_options` parameter, check out the [Session](/concepts/sessions#recall-options) page.
  - To use the chat API, you need to create a session first. To learn more about the session object, check out the [Session](/concepts/sessions) page.
</Info>
