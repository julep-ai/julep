...
```
In any steps following the label step, you can access the values set in the label step using the `$ label_name.attribute_name` syntax. For example:

```yaml YAML
- log: $ get_user_name.user_name
- log: $ get_count_and_has_data.count
- log: $ get_count_and_has_data.has_data
```
## Iteration Steps
