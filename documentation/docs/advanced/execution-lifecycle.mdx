...
Let's explore this through the lens of a Trip Plan task - a practical example that showcases key aspects of task execution.
...
<Frame caption="Understanding the Execution Lifecycle through Trip Plan Task">
  <img
    src="/images/execution-lifecycle.png"
    alt="Trip Plan Execution Lifecycle"
  />
</Frame>
...
<CardGroup cols={2}>
  <Card
    title="Checkout the Actual Tutorial for Trip Plan"
    icon="rocket"
    href="/docs/tutorials/trip-planning"
  >
    Checkout the actual tutorial for Trip Plan
  </Card>
</CardGroup> 