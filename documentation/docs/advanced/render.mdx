...
<Info>  
  ...
  - To use the render endpoint, you need to create a session first. To learn more about the session object, check out the [Session](/docs/concepts/sessions) page.
</Info>
