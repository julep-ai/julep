...
about: 'Learn how to process and analyze videos using Julep'
icon: 'display'
---
...
<Accordion title="Complete Task YAML" icon="code">
  ...
  about: A Julep agent that can process and analyze videos using Cloudinary
...
- To learn more about the integrations used in this task, check out the [integrations](/docs/integrations/supported-integrations) page.
```