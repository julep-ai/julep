...
#### Step 2: Process and Index Content
...
## Using the Crawled Content

Once content is crawled and stored, you can create a session to interact with it:
...
An example output when running this task with an input of `{"url": "https://julep.ai/", "pages_limit": 5}`:
