...
<Note>
  The @babel/runtime dependency has been updated to version 7.26.10. Ensure compatibility with your project by reviewing any related changes or requirements.
</Note>
```