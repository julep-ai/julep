...
openai_client = OpenAI(base_url="https://localhost:8080/api", api_key="YOUR_JULEP_API_KEY")
```
...
This section will guide you through the steps to setup the Responses API using Docker.
