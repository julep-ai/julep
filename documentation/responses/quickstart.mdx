...
The Julep's Open Responses API is a fully microservice-based architecture. It fully dockerized and can be easily deployed on any infrastructure that supports Docker. There are two ways to install the API:
