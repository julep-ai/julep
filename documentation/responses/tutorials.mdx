---
title: 'Tutorial'
description: 'Tutorials for Julep Open Responses API using OpenAI SDKs'
icon: 'code'
---
...
- [Return to the Quickstart guide](/responses/quickstart) - To get started with the Julep Open Responses API.
- [Learn more about Julep](/docs/introduction/julep) - To learn more about Julep.
- [Learn more about the Open Responses API concepts](/responses/concepts) - To learn more about the concepts of the Julep Open Responses API.
- [Learn more about the Open Responses API Roadmap](/responses/roadmap) - To learn more about the roadmap of the Julep Open Responses API.
