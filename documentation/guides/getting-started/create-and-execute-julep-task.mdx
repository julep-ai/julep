...
<Info>
This guide is based on the Trip Planning task. For a detailed explanation of the task's workflow, please check out the corresponding [Trip Planning tutorial](/docs/tutorials/trip-planning).
</Info>
...
- [Tasks](/docs/concepts/tasks) - Learn about Julep tasks in more details and see other tasks steps.  
- [Tutorials](/docs/tutorials) - Check out other tutorials to see more real-world examples of Julep in action.
