...
| cerebras/llama-4-scout-17b-16e-instruct | 10M tokens | General purpose tasks, long-context processing, code analysis (Much faster than other deployements at over 2,600 token/sec) |
