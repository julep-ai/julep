...
| claude-3-opus | 200K tokens | 4K tokens | ✅ | ✅ | ❌ | ✅ | Enterprise |
...
| claude-3.5-sonnet-20240620 | 200K tokens | 8K tokens | ✅ | ✅ | ❌ | ✅ | Premium |
| claude-3.5-sonnet-20241022 | 200K tokens | 8K tokens | ✅ | ✅ | ❌ | ✅ | Premium |
| claude-3.7-sonnet | 200K tokens | 128K tokens | ✅ | ✅ | ❌ | ✅ | Premium |
...
| llama-3.1-70b | 8K tokens | 8K tokens | ✅ | ❌ | ❌ | ❌ | Standard |
...
| mistral-saba-24b | 32K tokens | 32K tokens | ❌ | ❌ | ❌ | ❌ | Standard |
| qwen-qwq-32b | 128K tokens | 128K tokens | ✅ | ❌ | ❌ | ❌ | Budget |
| qwen/qwen3-32b | Unknown | Unknown | ❌ | ❌ | ❌ | ❌ | Unknown |
...
| Model Name | Context Window | Max Output | Tool Calling | Vision | Audio | Caching | Cost Tier |
|------------|----------------|------------|--------------|--------|-------|---------|----------|
| cerebras/deepseek-r1-distill-llama-70b | 128K tokens | 128K tokens | ✅ | ❌ | ❌ | ❌ | Standard |
| cerebras/llama-3.1-8b | 128K tokens | 128K tokens | ✅ | ❌ | ❌ | ❌ | Budget |
| cerebras/llama-3.3-70b | 128K tokens | 128K tokens | ✅ | ❌ | ❌ | ❌ | Standard |
| cerebras/llama-4-scout-17b-16e-instruct | 131K tokens | 8K tokens | ✅ | ❌ | ❌ | ❌ | Budget |
| cerebras/qwen-3-32b | 128K tokens | 128K tokens | ✅ | ❌ | ❌ | ❌ | Budget |
