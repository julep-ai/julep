...
<Info>
**GPT-5 Models**: Released on August 7, 2025, GPT-5 models feature a massive 400K token context window and 128K max output tokens. Available in three variants:
- **gpt-5**: Full capability model for reasoning and tool use ($1.25/$10 per 1M input/output tokens)
- **gpt-5-mini**: Cost-optimized for practical workloads ($0.25/$2 per 1M input/output tokens)
- **gpt-5-nano**: Ultra-lightweight for high-speed batch tasks ($0.05/$0.40 per 1M input/output tokens)

All GPT-5 models support new `reasoning_effort` (minimal, low, medium, high) and `verbosity` (low, medium, high) parameters for fine-tuned control over response behavior.
</Info>
...
| gpt-5 | 400K tokens | 128K tokens | ✅ | ✅ | ✅ | ✅ | Premium |
| gpt-5-mini | 400K tokens | 128K tokens | ✅ | ✅ | ✅ | ✅ | Budget |
| gpt-5-nano | 400K tokens | 128K tokens | ✅ | ✅ | ✅ | ✅ | Budget |
| gpt-5-chat | 400K tokens | 128K tokens | ✅ | ✅ | ✅ | ✅ | Premium |
| gpt-5-chat-latest | 400K tokens | 128K tokens | ✅ | ✅ | ✅ | ✅ | Premium |
| gpt-5-2025-08-07 | 400K tokens | 128K tokens | ✅ | ✅ | ✅ | ✅ | Premium |
...
| meta-llama/Llama-Guard-4-12B | Unknown | Unknown | ❌ | ❌ | ❌ | ❌ | Unknown |
