...
group carries a :class:`~julep.ir.Merge` marker describing the join
...
:func:`julep.deploy.deploy` as a blocking gate.
"""
...
def map_n(*flows: Node, reducer: Optional[str] = None) -> Node:
    ...
    Like :func:`julep.dsl.par`, but attaches an explicit ``all``
