...
from julep.ca.doctor import overall_code, run_checks
from julep.ca.langfuse_link import trace_url
from julep.ca.lint import lint_agents
from julep.ca.listen import listen_command
from julep.ca.model import Module, build_module
from julep.ca.runcache import load_run, save_run
from julep.ca.runner import RunOutcome, run_agent_local
from julep.ca.select import select
from julep.ca.status import status_exit_code, status_for_env
...
def eval_cmd(
    ...
    """
    from julep.ca.evalrun import diff_reports, run_eval_sync
