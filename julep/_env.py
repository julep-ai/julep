...
JULEP_WASM_ENABLED: Final = "JULEP_WASM_ENABLED"
JULEP_WASM_DEPENDENCIES_ENABLED: Final = "JULEP_WASM_DEPENDENCIES_ENABLED"
...
JULEP_BLOB_STORE_URL: Final = "JULEP_BLOB_STORE_URL"
...
LEGACY_ENV_VAR_RENAMES: Final[Mapping[str, str]] = MappingProxyType(
    {
        ...
        "COMPOSABLE_WASM_ENABLED": JULEP_WASM_ENABLED,
        "COMPOSABLE_WASM_DEPENDENCIES_ENABLED": JULEP_WASM_DEPENDENCIES_ENABLED,
    }
)
...
__all__ = [
    ...
    "JULEP_WASM_DEPENDENCIES_ENABLED",
    "JULEP_WASM_ENABLED",
    "JULEP_WASM_EPOCH_MS",
    "JULEP_WASM_FUEL",
