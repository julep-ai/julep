...
- [Julep](julep/index.md#julep)
    - [Api](julep/api/index.md#api)
        ...
        - [Types](julep/api/types/index.md#types)
            - [AdditionalInfo](julep/api/types/additional_info.md#additionalinfo)
            ...
            - [CreateAdditionalInfoRequest](julep/api/types/create_additional_info_request.md#createadditionalinforequest)
            ...
            - [GetAgentAdditionalInfoResponse](julep/api/types/get_agent_additional_info_response.md#getagentadditionalinforesponse)
            ...
            - [GetUserAdditionalInfoResponse](julep/api/types/get_user_additional_info_response.md#getuseradditionalinforesponse)
