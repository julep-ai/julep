 ...
 * ```
 */
export type HeaderDecorator = (context: DecoratorContext, target: ModelProperty, headerNameOrOptions?: Type) => void;
/**
 ...
 * ```
 */
export type RouteDecorator = (context: DecoratorContext, target: Namespace | Interface | Operation, path: string, options?: Type) => void;
/**
