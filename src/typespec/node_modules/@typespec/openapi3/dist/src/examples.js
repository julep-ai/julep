import { getOpExamples, ignoreDiagnostics, serializeValueAsJson, } from "@typespec/compiler";
import { getOpenAPI3StatusCodes } from "./status-codes.js";
import { isSharedHttpOperation } from "./util.js";
export function resolveOperationExamples(program, operation) {
    const examples = findOperationExamples(program, operation);
    const result = { requestBody: {}, responses: {} };
