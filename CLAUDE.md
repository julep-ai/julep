...
## 10. Directory-Specific CLAUDE.md Files
...
## 15. Meta: Guidelines for updating CLAUDE.md files
...
*   @.cursorignore : Specifies files that should be ignored by the Cursor IDE, including:
...
*   @.cursorindexignore : Controls which files are excluded from Cursor's indexing to improve performance, including:
    *   All files in `.cursorignore`
