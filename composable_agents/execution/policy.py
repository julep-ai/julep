...
class ExecutionPolicy:
    ...
    # Engine retries for invokeReasoner/compilePlan (Temporal only; DBOS reasoner
    ...
    def to_json(self) -> dict[str, Any]:
        out = {
            "toolTimeoutS": self.tool_timeout_s,
            "reasonerTimeoutS": self.reasoner_timeout_s,
            ...
            "reasonerMaxAttempts": self.reasoner_max_attempts,
    ...
    def from_json(d: Optional[dict[str, Any]]) -> "ExecutionPolicy":
        ...
        return ExecutionPolicy(
            tool_timeout_s=d.get("toolTimeoutS", base.tool_timeout_s),
            reasoner_timeout_s=d.get("reasonerTimeoutS", base.reasoner_timeout_s),
            ...
            reasoner_max_attempts=d.get("reasonerMaxAttempts", base.reasoner_max_attempts),
