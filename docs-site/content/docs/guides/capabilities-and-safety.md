...
in strict mode. See [Documentation](/docs), [Concepts](/docs/concepts/model), and
[SPEC §5](/docs/internals/specification#5-compile-pipeline).
...
This is normative in [SPEC §7.1](/docs/internals/specification#71-absent-vs-empty). In
...
deployment artifact. See [SPEC §7.2](/docs/internals/specification#72-grant-sections).
...
[SPEC §5](/docs/internals/specification#5-compile-pipeline) and [SPEC §8.3](/docs/internals/specification#83-race--hedge--quorum).
...
Approval gating is specified in [SPEC §7.3](/docs/internals/specification#73-approval-gating-new--required),
human gate behavior in [SPEC §8.6](/docs/internals/specification#86-human-gate), and agent-loop grant
behavior in [SPEC §10](/docs/internals/specification#10-agent-loop).
...
Related: [First Agent](/docs/start/first-agent), [Temporal](/docs/deploy/temporal),
