...
Environment knob: `JULEP_SOURCE_CAPTURE=1` enables raw DSL source
...
`JULEP_SOURCE_CAPTURE=1` and `set_source_capture(True | False)`
...
<!-- generated by julep-docs-matrix: flow-frontend/reference -->

<!-- ported-by julep-docs-site: reference/flow-api -->
